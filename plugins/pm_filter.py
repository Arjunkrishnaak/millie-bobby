...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("THIS IS NOT YOUR REQUEST ! REQUEST AGAIN AND CLICK HERE", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('JOIN GROUP', url=f'https://t.me/Request_flix')
            ],[
            InlineKeyboardButton('MOVIE CHANNEL', url='https://t.me/collection_sandm'),
            InlineKeyboardButton('SERIES CHANNEL', url='https://t.me/joinchat/5T5yvugUmM9mN2Q1')
            ],[
